...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="admin/style_tanaman.css">
	<link rel="stylesheet" type="text/css" href="css/style_keg.css">
  <link rel="stylesheet" type="text/css" href="admin/style_tampilan.css">
...
<body>
	...
	<section class="about">
		<div class="container">
			<h3><a href="tentang.php">APA ITU P2L?</a></h3>
	...
	<div class="kegiatan">
		<div class="container">
			<h2><a href="kegiatan.php">KEGIATAN P2L</a></h2>
			<div class="konten">
				<?php
				...
				while($row = mysqli_fetch_array($data)){
					?>
				<div class="feedkegiatan1">
				<img src="img/kegiatan/<?= $row['gambar']?>" alt="<?= $row['judul'];?>">
				<h3><a href="kegiatan.php"><?= $row['judul'];?></a></h3>
				<hr>
	...
	<div class="tanaman">
		<div class="container">
			<h2><a href="tanaman.php">TANAMAN P2L</h2>
		</div>
	</div>
  ...
  <div class="moretnm">
    <h3><a href="tanaman.php">TAMPILKAN TANAMAN LAINNYA  <i class="fa-solid fa-angles-right"></i></a></h3>
  </div>
